   ...
   // private LocationListener locationListener;
    ...
    public void determineLocation() {
        ...
        if (locationManager != null) {
            ...
            if (loc != null) {
                owner.doAddress(loc.getLatitude(), loc.getLongitude());
        ...
        if (locationManager != null) {
            ...
            if (loc != null) {
                String address = owner.doAddress(loc.getLatitude(), loc.getLongitude());
